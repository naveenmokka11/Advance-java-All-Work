...
<%Bank bank=(Bank)request.getAttribute("bal"); %>
<header>
 <nav>
...
<section>
 <br>
<br>
<div style="border: 3px solid black;width: 350px; height: 480px; ">
<br>
<br>
<h2>your account balance is</h2>
Rs: <input id="amountdisplay" value="<%=bank.getBankBalance()%> "readonly="true">
<img
src="https://th.bing.com/th/id/OIP.EYcqv21EGKgsoVN03kl2ngHaH0?w=156&h=180&c=7
&r=0&o=5&dpr=1.3&pid=1.7" style="height: 250px;">
<br>
<button><a href="buttons.html" style="color: white; text-decoration:
none;">BACK</a></button>
</div>
</section>
</center>
...
class="fa-brands fa-instagram"></i>
 ...
 <footer class="footer">
 <p>Terms and conditions Do Not Call Registry Disclaimer Multilingual Disclaimer
Code of Commitment Group Code of Business Conduct and Ethics Customer Service
Policies Use of Unparliamentary Language by Customers Privacy Fair Practice Code for
Lenders DICGC Deposit Insurance</p>
 </footer>
